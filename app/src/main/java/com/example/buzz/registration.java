    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rg_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String status = "Hey there! I'm using Iris";
                ...
                if (TextUtils.isEmpty(namee) || TextUtils.isEmpty(emaill) ||
                    ...
                    progressDialog.dismiss();
                    rg_password.setError("Password Must Be 6 Characters long");
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                if (imageURI!=null){
                                    ...
                                    String status = "Hey there! I'm using Iris";
                                    imageuri = "https://firebasestorage.googleapis.com/v0/b/buzz-64f4b.appspot.com/o/user.webp?alt=media&token=af829022-96fc-4142-b2af-4cd7e49351de";
                                    Users users = new Users(id,namee,emaill,Password,imageuri,status);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
