...
import static com.example.buzz.chat_win.reciverIImg;
import static com.example.buzz.chat_win.senderImg;
...
public class messagesAdapter extends RecyclerView.Adapter {
    Context context;
    ArrayList<msg_model_class> messagesAdapterArrayList;
    int ITEM_SEND=1;
    int ITEM_RECIVE=2;

    public messagesAdapter(Context context, ArrayList<msg_model_class> messagesAdapterArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        msg_model_class messages = messagesAdapterArrayList.get(position);
